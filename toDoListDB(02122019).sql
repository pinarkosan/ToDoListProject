...
IF NOT EXISTS(select * from dbo.TodoLists where ListId='Books to read')
BEGIN
insert into dbo.TodoLists values('Books to read','1')
END
GO
IF NOT EXISTS(select * from dbo.TodoLists where ListId='Sights')
BEGIN
insert into dbo.TodoLists values('Sights','1')
END
GO
IF NOT EXISTS(select * from dbo.TodoLists where ListId='Foreign Language')
BEGIN
